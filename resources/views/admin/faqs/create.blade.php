    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="breadcrumb">
            ...
            <ul>
                <li><a style="color: blue; border-bottom: 1px solid blue "  href="{{ route('faqs.index') }}">Все данные</a></li>
            </ul>
        </div>
        </div>
      </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                  ...
                                  <input class="form-control @error('title_en') is-invalid @enderror"
                                         autocomplete="off" placeholder="Например: Bakalavr" name="title_en" type="text">
                                  @error('title_en')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
