    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="breadcrumb">
            ...
            <ul>
                <li><a style="color: blue; border-bottom: 1px solid blue "  href="{{ route('customerfeedbacks.index') }}">Все данные</a></li>
            </ul>
        </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('customerfeedbacks.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-4 form-group mb-3">
                                    <label>Имя клиента (uz)</label>
                                    <input class="form-control @error('customer_name_uz') is-invalid @enderror"
                                ...
                                <div class="col-md-4 form-group mb-3">
                                  ...
                                  <input class="form-control @error('customer_name_ru') is-invalid @enderror"
                                ...
                                <div class="col-md-4 form-group mb-3">
                                  ...
                                  <input class="form-control @error('customer_name_en') is-invalid @enderror"
                                ...
                                <div class="col-md-4 form-group mb-3">
                                  ...
                                  <input class="form-control @error('text_uz') is-invalid @enderror"
                                         autocomplete="off" placeholder="Например: Tекст" name="text_uz" type="text">
                                  @error('text_uz')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
                                ...
                                <div class="col-md-4 form-group mb-3">
                                  ...
                                  <input class="form-control @error('text_en') is-invalid @enderror"
