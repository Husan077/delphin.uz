...
@section('main')
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <ul>
                <li><a href="{{ route('banners.create') }}">Добавить новую баннер</a></li>
            </ul>
        </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($banners as $banner)
                                            <tr>
                                                ...
                                                <td>{{ $banner->title_name_ru }}</td>
                                                <td>{{ $banner->text_ru }}</td>
                                                <td class="d-flex">
                                                    <a class="text-success mr-2" href="{{ route('banners.edit', $banner->id) }}"><i class="nav-icon fas fa-pen font-weight-bold"></i></a>
                                                    <a data-toggle="modal" data-target="#deletesModal{{$banner->id}}" class="text-danger mr-2" href="#"><i class="nav-icon far fa-times-circle font-weight-bold"></i></a>
