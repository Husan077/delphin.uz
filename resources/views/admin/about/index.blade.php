...
@section('main')
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <ul>
                <li><a href="{{ route('abouts.create') }}">Добавить новые данные</a></li>
            </ul>
        </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($about as $abt)
                                            <tr>
                                                ...
                                                <td>{{ $abt->level_ru }}</td>
                                                <td class="d-flex">
                                                    <a class="text-success mr-2" href="{{ route('abouts.edit', $abt->id) }}"><i class="nav-icon fas fa-pen font-weight-bold"></i></a>
                                                    <a data-toggle="modal" data-target="#deletesModal{{$abt->id}}" class="text-danger mr-2" href="#"><i class="nav-icon far fa-times-circle font-weight-bold"></i></a>
