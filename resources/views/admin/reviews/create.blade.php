...
@section('title')
    Добавыть новый отзыв
@endsection

@section('main')
    <div class="main-content">
        <div class="breadcrumb">
            <h1 class="mr-2">Добавыть новый отзыв</h1>
            <ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('client_name_ru') is-invalid @enderror"
                                           autocomplete="off" placeholder="Например: Хусан Тургунов" name="client_name_ru" type="text">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('client_name_uz') is-invalid @enderror"
                                           autocomplete="off" placeholder="Например: Husan Turg'unov" name="client_name_uz" type="text">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('job_name_ru') is-invalid @enderror"
                                           autocomplete="off" placeholder="Например: Веб-разработчик" name="job_name_ru" type="text">
                                    @error('job_name_ru')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('job_name_uz') is-invalid @enderror"
                                           autocomplete="off" placeholder="Например: Veb-dasturchi" name="job_name_uz" type="text">
                                    @error('job_name_uz')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('text_uz') is-invalid @enderror" autocomplete="off"
                                              placeholder="Например: Yaxshi eshik vva romlar kerak edi...." name="text_uz" type="text">
                                    </textarea>
                                    @error('text_uz')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('text_ru') is-invalid @enderror" autocomplete="off"
                                              placeholder="Например:  Нужны былы самые ....." name="text_ru" type="text">
                                    </textarea>
                                    @error('text_ru')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
