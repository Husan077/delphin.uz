    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="breadcrumb">
            ...
            <ul>
                <li><a style="color: blue; border-bottom: 1px solid blue "  href="{{ route('customerimages.index') }}">Все данные</a></li>
            </ul>
        </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('customerimages.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
